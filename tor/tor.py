...
def update():
    ...
    if "tor" not in db.list_collection_names():
        collection = db.create_collection("tor")
    ...
    try:
        ...
        response = client.chat_postMessage(
            channel="C05M5TZ67J6",
            text=f'TOR-DB-Insertion for {start_time} started \n Total-Docs:{num_docs}\n TOR-DB-Insertion ended! {end_time}\n Total Docs: {num_docs_end}'
        )
